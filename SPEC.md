...
T1|.|swap 91-users.yaml Username+Email: etremblay→qa-director, mvance→vp-supply-chain, dsingh→receiving-supervisor, sarchambault→erp-architect; keep FirstName LastName + ERP Roles|V1,V2,V3,V5
